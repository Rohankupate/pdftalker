...
// import { OpenAIEmbeddings } from 'langchain/o'
...
const onUploadComplete = async ({
  ...
  try {
    ...
    // console.log("the embeddings is  is  =  " , embeddings)
    // console.log("the createdFile is  is  =  " , createdFile)
    // console.log("the pageLevelDocs is  is  =  " , pageLevelDocs)
 try {
